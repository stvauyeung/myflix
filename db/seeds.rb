...
molly = User.create(name: "Molly", email:"molly@molly.com", password: "password")
5.times { Fabricate(:user) }

Fabricate(:queuing, user: molly, video: Video.find(1))
Fabricate(:queuing, user: molly, video: Video.find(3))
Fabricate(:queuing, user: molly, video: Video.find(4))
Fabricate(:queuing, user: molly, video: Video.find(5))
Fabricate(:queuing, user: molly, video: Video.find(7))

Fabricate(:following, user_id: 2, follower_id: 1)
Fabricate(:following, user_id: 3, follower_id: 2)
Fabricate(:following, user_id: 1, follower_id: 2)
Fabricate(:following, user_id: 4, follower_id: 2)
Fabricate(:following, user_id: 5, follower_id: 2)
Fabricate(:following, user_id: 7, follower_id: 2)
Fabricate(:following, user_id: 2, follower_id: 3)
Fabricate(:following, user_id: 2, follower_id: 4)
Fabricate(:following, user_id: 2, follower_id: 5)
Fabricate(:following, user_id: 7, follower_id: 3)
Fabricate(:following, user_id: 6, follower_id: 3)
Fabricate(:following, user_id: 5, follower_id: 3)

User.find(1).reviews << Fabricate(:review, video: Video.find(1))
User.find(2).reviews << Fabricate(:review, video: Video.find(2))
User.find(3).reviews << Fabricate(:review, video: Video.find(3))
User.find(2).reviews << Fabricate(:review, video: Video.find(3))
User.find(2).reviews << Fabricate(:review, video: Video.find(4))
User.find(1).reviews << Fabricate(:review, video: Video.find(2))
User.find(3).reviews << Fabricate(:review, video: Video.find(5))
User.find(4).reviews << Fabricate(:review, video: Video.find(5))
User.find(4).reviews << Fabricate(:review, video: Video.find(4))
User.find(5).reviews << Fabricate(:review, video: Video.find(3))
User.find(5).reviews << Fabricate(:review, video: Video.find(2))
User.find(6).reviews << Fabricate(:review, video: Video.find(1))
User.find(6).reviews << Fabricate(:review, video: Video.find(2))
User.find(7).reviews << Fabricate(:review, video: Video.find(3))
User.find(7).reviews << Fabricate(:review, video: Video.find(4))
